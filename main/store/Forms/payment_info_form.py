...
class PaymentInfoForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'exp_mm': widgets.NumberInput(attrs={'class': 'form-control', 'placeholder': 'MM', 'label': 'Expiration Date'}),
            'exp_yy': widgets.NumberInput(attrs={'class': 'form-control', 'placeholder': 'YY'}),
            ...
            'zip_code': widgets.TextInput(attrs={'class': 'form-control', 'placeholder': 'Zip-code'}),
